...
VALUES('Administrator','admin','admin',1),('Oficiant','oficiant','1',0),('User','0','0',-1)
GO
...
VALUES('1',0),('2',1)
GO
INSERT INTO Food(name_food,cost_price_food,mark_up,price_food,kod_category)
VALUES('Coca-Cola',10,0.1,11,1),('Salat',20,0.2,24,2)
GO
